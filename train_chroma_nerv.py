...
def append_csv(metrics, checkpoint_path, visual_dir, args):
    ...
    row = {
        ...
        'gflops_per_output_megapixel': f"{metrics['gflops_per_output_megapixel']:.4f}",
...
def evaluate(model, dataloader, positional_encoding, device, checkpoint_path, epoch, args):
    ...
    metrics.update({
        ...
        'gflops_per_output_megapixel': estimated_gflops / (
            args.target_height * args.target_width / 1_000_000.0),
